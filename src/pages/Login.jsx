      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="bg-neutral-900/80 backdrop-blur border border-neutral-800 rounded-2xl p-6 shadow-2xl shadow-black/40">
          ...
          {requiresVerification && (
            <div className="mb-4 px-3.5 py-2.5 bg-amber-500/10 border border-amber-500/30 rounded-xl text-amber-400 text-sm">
              <p className="mb-2">Votre email n'a pas encore été vérifié.</p>
              <Link
