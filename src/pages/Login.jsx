    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-primary-500">🎵 Worship Team</h1>
          <p className="text-gray-400 mt-2">Gestion de votre équipe de louange</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-gray-800 rounded-xl p-8 shadow-lg">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-6 px-4 py-3 bg-primary-600 hover:bg-primary-700 disabled:opacity-50 rounded-lg font-medium transition"
          >
