    ...
    <div className="p-4 md:p-6 space-y-4 md:space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-3 md:p-4">
          <label className="block text-sm font-medium text-gray-400 mb-2 md:mb-3">
        ...
        {memberStats.length === 0 ? (
          ...
          <div className="divide-y divide-gray-700">
            {memberStats.map((member, index) => (
              <div
                key={member._id}
                className={`p-3 md:p-4 hover:bg-gray-900/50 transition ${
              ...
              >
                ...
                <div className="flex flex-col gap-3 md:hidden">
                  ...
                  <div className="flex items-center gap-3">
                    <span className={`text-2xl font-bold flex-shrink-0 w-8 text-center ${
                    ...
                    <div className="text-right flex-shrink-0">
                      <div className={`text-xl font-bold ${getRateColor(member.stats.presenceRate)}`}>
