          ...
          {period === 'custom' && (
            <div className="mt-3 flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 bg-neutral-800 border border-neutral-700 rounded-lg text-neutral-100 text-sm"
                placeholder="Début"
              />
              <input
                type="date"
        ...
        {loading ? (
          ...
          <div className="divide-y divide-neutral-800">
            {memberStats.map((member, index) => (
              <div
                key={member._id}
                className={`p-3 md:p-4 hover:bg-neutral-900/60 transition ${
