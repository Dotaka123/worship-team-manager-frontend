...
import { Download, Plus, ChevronLeft, ChevronRight, Loader2, Check, X } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-red-600 text-white px-3 sm:px-4 py-2 rounded-lg hover:bg-red-700 disabled:opacity-50 text-sm"
          >
