...
/* ── Stat card cliquable ── */
const StatCard = ({ icon: Icon, label, value, iconBg, iconColor, hoverBorder, filterRole, navigate }) => (
  <button
    onClick={() => {
    ...
    className={`bg-neutral-900 border border-neutral-800 rounded-xl p-5 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/20 ${hoverBorder} cursor-pointer text-left w-full`}
  >
    ...
    <div className="max-w-7xl mx-auto p-4 md:p-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 mb-6">
        {loading
          ...
          : statConfig.map((cfg) => (
              <StatCard key={cfg.key} {...cfg} value={stats[cfg.key]} navigate={navigate} />
            ))
        }
      </div>
