    ...
    <div className="relative">
      ...
      {showPanel && (
        <>
          ...
          />
          <div className="fixed md:absolute right-0 top-[58px] md:top-full md:right-0 z-50 w-full md:w-96 max-h-[calc(100vh-4rem)] md:max-h-[580px] bg-neutral-900 border border-neutral-800 md:rounded-xl shadow-2xl shadow-black/50 overflow-hidden md:mt-2">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-neutral-800 bg-neutral-950/50">
              ...
              <button
                onClick={() => setShowPanel(false)}
                className="p-1 text-neutral-500 hover:text-neutral-200 hover:bg-neutral-800 rounded-lg transition"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
                ...
                <div className="p-2 flex flex-col gap-1.5">
                  {notifications.map(notif => {
                    ...
                    return (
                      <div
                        key={notif.id}
                        className={`flex items-start gap-3 p-3 rounded-xl border transition-all ${cfg.bg} ${cfg.border}`}
                      >
                        ...
                        <button
                          ...
                          className="p-0.5 text-neutral-600 hover:text-neutral-300 rounded transition shrink-0"
                        >
            ...
            {notifications.length > 0 && (
              <div className="px-4 py-3 border-t border-neutral-800">
                <button
                  ...
                  className="w-full text-xs text-neutral-500 hover:text-neutral-300 transition py-1"
                >
                  Tout effacer
                </button>
              </div>
