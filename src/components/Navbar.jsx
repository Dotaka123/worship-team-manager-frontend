  ...
  return (
    <nav className="bg-neutral-900/80 backdrop-blur-md border-b border-neutral-800/60 sticky top-0 z-50">
      <div className="container mx-auto px-4">
        ...
        {/* ── Mobile Menu ── */}
        {isMenuOpen && (
          <div className="md:hidden py-3 border-t border-neutral-800/60">
            <div className="flex flex-col gap-0.5">
              ...
              <div className="mt-2 pt-2 border-t border-neutral-800 flex items-center justify-between px-3">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-neutral-400 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition"
                >
