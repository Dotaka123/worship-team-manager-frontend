...
const MemberForm = ({ member, onSubmit, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-neutral-950/90 z-50 overflow-y-auto">
      <div className="flex min-h-full items-center justify-center p-4">
      <div className="bg-neutral-900 border border-neutral-800 rounded-lg max-w-2xl w-full shadow-xl my-4">
